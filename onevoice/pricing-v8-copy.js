(function () {
  ...
  var overrides = {
    ...
    kc600c5716f: copy('Two numbers, 500 minutes, and a lower overage rate.', 'Dos números, 500 minutos y una tarifa de exceso menor.', 'Zwei Nummern, 500 Minuten und ein günstigerer Mehrminutenpreis.', 'Два номера, 500 минут и более низкая цена сверх лимита.', '两个号码、500 分钟和更低的超额费率。', 'Dois números, 500 minutos e menor tarifa excedente.'),
